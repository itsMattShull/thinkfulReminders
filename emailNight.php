...
$timeMin = $nextDate."T02:00:00-06:00";
$timeMax = $nextDate."T10:59:59-06:00";
...
foreach ($events->getItems() as $event) {
	foreach ($event->getAttendees() as $attendee) {
		...
		$messages=array(
			...
			"Hey $name,<br><br>Wanted to remind you of our session tomorrow at $time CST.  See you then!
			<br>
			<h3 style='margin:0;'>Matt Shull</h3>
			FEWD & Angular Mentor @ <a href='http://www.thinkful.com' target='_blank'>Thinkful.com</a>
			<br>Co-Creator and Contributor @ <a href='http://www.rhinoio.com' target='_blank'>RhinoIO.com</a>",
			"Hey $name,<br><br>Just wanted to remind you about our session tomorrow at $time CST.  See you then!
			<br>
			<h3 style='margin:0;'>Matt Shull</h3>
			FEWD & Angular Mentor @ <a href='http://www.thinkful.com' target='_blank'>Thinkful.com</a>
			<br>Co-Creator and Contributor @ <a href='http://www.rhinoio.com' target='_blank'>RhinoIO.com</a>",
			"Hey $name,<br><br>Don't forget about our session tomorrow on at $time CST.  See you then!
			<br>
			<h3 style='margin:0;'>Matt Shull</h3>
			FEWD & Angular Mentor @ <a href='http://www.thinkful.com' target='_blank'>Thinkful.com</a>
			<br>Co-Creator and Contributor @ <a href='http://www.rhinoio.com' target='_blank'>RhinoIO.com</a>",
			"Hey $name,<br><br>Quick reminder about our session tomorrow at $time CST.  See you then!
			<br>
			<h3 style='margin:0;'>Matt Shull</h3>
			FEWD & Angular Mentor @ <a href='http://www.thinkful.com' target='_blank'>Thinkful.com</a>
			<br>Co-Creator and Contributor @ <a href='http://www.rhinoio.com' target='_blank'>RhinoIO.com</a>"
